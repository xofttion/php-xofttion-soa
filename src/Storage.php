...
class Storage extends StorageORM implements IStorage {
    ...
    protected function attachModel(?IModel $model): ?IModel {
        ...
        } // Se conoce unidad de almacenamiento, cargando modelo
        
        return $model; // Retornando modelo generado desde almacén
    }
    ...
    protected function attachCollection(Collection $collection): Collection {
        foreach ($collection as $model) {
            $this->attachModel($model); // Cargando modelo en unidad
        } 
        
        return $collection; // Retornado modelos generados desde almacén
    }
}